...
\frame{
  ...
  \item \includegraphics[width=2.5cm]{stackoverflow}
    \begin{itemize}
...
\begin{frame}[fragile]{Basic optimization techniques: Loop fusion}
...
\begin{frame}[fragile]{Basic optimization techniques: Loop unrolling}
...
\begin{frame}[fragile]{Basic optimization techniques: Loop unroll-and-jam}
...
\begin{frame}[fragile]{Basic optimization techniques: Loop interchange}
...
\begin{frame}[fragile]{Basic optimization techniques: Loop peeling}
