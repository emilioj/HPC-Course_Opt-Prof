...
\subsection{Computer organization \& architecture: basics}
...
\subsection{High performance computing (HPC): basics}
...
\frame{
  ...
  \item different \emph{``types of memory''} {\small (even when talking about \emph{Main Memory})}
